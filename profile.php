...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			...
			echo "password: &nbsp;<a href='change-password.php' class='btn btn-skin' role='button'>
			change password</a><br><br>";


			$sql2 = "SELECT * FROM store  WHERE M_ID = '".$_SESSION['Mid']."'";
			...
			$store_owner = $row['S_Owner'];
			echo "storename: &nbsp;".$store_name."<br><br>";
			echo "storeaddress: &nbsp;".$store_address."<br><br>";
			echo "owner: &nbsp;".$store_owner."<br><br>";
			?>
